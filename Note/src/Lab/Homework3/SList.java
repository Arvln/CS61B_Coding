...
public class SList {
    ...
    public void squish() {
        ...
        SList tmpList = new SList();
        int i = 1;
        while (i < this.size){
            if(i == 1){
                tmpList.insertEnd(this.head.item);
            }
            if(!this.head.equals(this.head.next)){
                tmpList.insertEnd(this.head.next.item);
            }
        ...
        while (j < tmpList.size){
            this.insertEnd(tmpList.head.item);
    ...
    public void twin() {
        ...
        for (SListNode currentNode = this.head; currentNode != null; currentNode = currentNode.next.next){
            SListNode copySListNode = new SListNode(currentNode.item);
            copySListNode.next = currentNode.next;
            currentNode.next = copySListNode;
        }
    }
